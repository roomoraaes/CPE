angular.module('morphCarousel', [])
  ...
  .directive('morphCarousel', ['$ionicGesture', '$timeout', '$morphCarousel', '$rootScope',
    function($ionicGesture, $timeout, $morphCarousel, $rootScope){
      ...
      var link = function(scope, el, attr) {
        ...
        scope.onStopCarousel = function(select_number){
          var numeroSelecionado = select_number.number;
          $rootScope.onStopCarousel(numeroSelecionado);
        }
        /**
            ...
            if (Math.abs(angle) < endAngle) {
              ...
              if (!scope.$$phase) {
                scope.$apply(function(){
                  ...
                  scope.onStopCarousel(scope.selectedItem);
              } else {
                scope.selectedItem = scope.items[itemIndex];
              }
            }
